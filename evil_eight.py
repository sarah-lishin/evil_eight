...
will_list = ["It will Never Happen Unless it is a Full Moon.", "Only if you Defeat the Vampires", "Should the Witches Agree, then Yes", "On the Third Night After the Ghouls Rise"]
other_list = ["Question Unclear, Try Again Meatbag", "You Never Know With These Things, Try Boiling It", "Deadly Nightshade Usually Works", "After You Choke, Of Course", "Try Brains, They Might Satisfy Your Cravings"]
